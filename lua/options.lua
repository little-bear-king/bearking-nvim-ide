...
vim.opt.conceallevel = 0                        -- so that `` is visible in markdown filesopop
...
-- vim.cmd(let g:python3_host_prog = "C:\\Users\\ryanb\\AppData\\Local\\Programs\\Python\\Python310\\python.exe" )
